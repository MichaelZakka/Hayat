import 'package:hayat/data/models/response/sponser_response.dart';

class SponsersResponse {
  List<SponserResponse>? data;
  Links? links;
  Meta? meta;

  SponsersResponse({this.data, this.links, this.meta});

  SponsersResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <SponserResponse>[];
      json['data'].forEach((v) {
        data!.add(new SponserResponse.fromJson(v));
      });
    }
  ...
  void merge(SponsersResponse other) {
